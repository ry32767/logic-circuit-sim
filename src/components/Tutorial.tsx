...
const STEPS: { title: string; body: string; icon: IconName }[] = [
  {
    icon: 'add_box',
    title: 'ゲートを置く・消す',
    body: 'サイドバーのゲートをキャンバスへドラッグ（タップでも可）して配置します。いらないゲートはドラッグして画面下のゴミ箱へ落とすと削除できます。',
  },
  {
    icon: 'share',
    title: '配線でつなぐ・外す',
    body: '出力ポート（右）から入力ポート（左）へドラッグするとつながります（順にタップでもOK）。配線をタップ、または入力ポートをドラッグして外すと切断できます。',
  },
  {
    icon: 'toggle_on',
    title: 'スイッチを切り替える',
